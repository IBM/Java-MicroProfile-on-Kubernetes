...
This project demonstrates the deployment of a Java based microservices application using Microprofile on IBM Bluemix Container Service using Kubernetes Cluster. 
